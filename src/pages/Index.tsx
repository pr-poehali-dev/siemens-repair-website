...
const services = [
  { icon: 'WashingMachine', title: 'Стиральные машины', desc: 'Не сливает, не крутит, шумит, ошибки на дисплее — устраним за один визит.', price: 'от 1 200 ₽' },
  { icon: 'Utensils', title: 'Посудомоечные машины', desc: 'Не моет, не набирает воду, течёт. Чистка, замена ТЭНа и насосов.', price: 'от 1 400 ₽' },
  { icon: 'CookingPot', title: 'Духовые шкафы', desc: 'Не греет, не держит температуру, не работает гриль или подсветка.', price: 'от 1 500 ₽' },
  { icon: 'Refrigerator', title: 'Холодильники', desc: 'Не морозит, обмерзает, гудит. Заправка фреоном, замена компрессора.', price: 'от 1 600 ₽' },
  { icon: 'Microwave', title: 'Варочные панели', desc: 'Индукционные и электрические: не включается, мигают индикаторы.', price: 'от 1 300 ₽' },
  { icon: 'Wind', title: 'Вытяжки и сушки', desc: 'Шум, вибрация, не работает мотор или подсветка. Диагностика бесплатно.', price: 'от 1 100 ₽' },
];
...
const advantages = [
  ...
  { icon: 'Cog', title: 'Оригинальные запчасти', desc: 'Только сертифицированные комплектующие Siemens' },
...
const faq = [
  ...
  { q: 'Вы используете оригинальные запчасти?', a: 'Да, мы работаем только с оригинальными и сертифицированными комплектующими Siemens. На все детали распространяется гарантия.' },
        ...
        <div className="container grid items-center gap-12 py-16 lg:grid-cols-2 lg:py-24">
          <div className="animate-fade-in">
            <span className="inline-flex items-center gap-2 rounded-full bg-siemens-light px-4 py-1.5 text-sm font-semibold text-siemens-dark">
              ...
              Авторизованный сервис · 12 лет опыта
            </span>
