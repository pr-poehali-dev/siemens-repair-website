...
const services = [
  ...
  { icon: 'Utensils', title: 'Посудомоечные машины', desc: 'Не моет, не набирает воду, течёт и др. Чистка, замена ТЭНа и насосов.', price: 'от 1 400 ₽' },
  { icon: 'CookingPot', title: 'Духовые шкафы', desc: 'Не греет, не держит температуру, не работает гриль, подсветка и др.', price: 'от 1 500 ₽' },
  { icon: 'Refrigerator', title: 'Холодильники', desc: 'Не морозит, обмерзает, гудит и др. Заправка фреоном, замена компрессора.', price: 'от 1 600 ₽' },
