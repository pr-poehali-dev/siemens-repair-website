      ...
      <main className="container max-w-3xl py-16">
        ...
        <div className="mt-10 space-y-8 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3">
              Все персональные данные хранятся на серверах, расположенных на территории Российской
              Федерации. Уведомления о новых заявках в мессенджеры отправляются в обезличенном виде —
              без передачи персональных данных за пределы РФ.
            </p>
          </section>
